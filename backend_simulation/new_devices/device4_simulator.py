"""
MQTT Simulator for Device 4
Simulates device4 by publishing sensor readings, valve status, VFD feedback, and device status
...
def log(message, level="INFO"):
    ...
    print(f"[{timestamp}] [{level}] Device4: {message}")
