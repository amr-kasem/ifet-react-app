...
// //       if (
// //         selectedValue >= 0 &&
// //         selectedValue < unfinishedTests.length &&
// //         selectedValue != null
// //       ) {
...
// //             )
// //           ) : // Custom Logic (Render Custom Rows)
// //           toggle === "dynamic_load" && customCyclicRows.length > 0 ? (
// //             customCyclicRows.map((test, index) => (
// //               <option key={`cyclic-${index}`} value={`custom-cyclic-${index}`}>
// //                 Custom Test {index + 1} {test.loadingDirection}
// //               </option>
// //             ))
// //           ) : toggle === "static_load" && customStaticRows.length > 0 ? (
// //             customStaticRows.map((test, index) => (
// //               <option key={`static-${index}`} value={`custom-static-${index}`}>
// //                 Custom Test {index + 1} {test.loadingDirection}
// //               </option>
// //             ))
// //           ) : (
...
// //     if (custom_preset_toggle === "Preset") {
// //       handlePresetTestSelection(selectedValue);
// //     } else {
// //       handleCustomTestSelection(selectedValue);
// //     }
// //   };

// //   // Handle preset test selection logic
// //   const handlePresetTestSelection = (selectedValue) => {
// //     if (toggle === "dynamic_load") {
// //       const selectedTest = CyclicTests.filter((test) => test.finished !== true)[selectedValue];
// //       setSelectedTestCyclicIndex(selectedTest.index);
// //       setTestParametersFromTest(selectedTest);
// //     } else if (toggle === "static_load") {
// //       const unfinishedTests = StaticTests.filter((test) => test.finished !== true);
// //       const selectedTest = unfinishedTests[selectedValue];
// //       setSelectedTestStaticIndex(selectedTest.index);
// //       setTestParametersFromTest(selectedTest);
// //     }
// //   };

// //   // Handle custom test selection logic
// //   const handleCustomTestSelection = (selectedValue) => {
// //     const customType = selectedValue.split("-")[1]; // "cyclic" or "static"
// //     const index = parseInt(selectedValue.split("-")[2]);

// //     let selectedCustomTest;
// //     if (customType === "cyclic") {
// //       selectedCustomTest = customCyclicRows[index];
// //     } else if (customType === "static") {
// //       selectedCustomTest = customStaticRows[index];
// //     }

// //     setButtonName("Start");
// //     setButtonClass("btn btn-success btn-lg");
// //     setSetPoint(selectedCustomTest.pressure);
// //     setHoldTime(selectedCustomTest.duration);
// //     setPositiveSetPoint(selectedCustomTest.airPressureCycles1);
// //     setNegativeSetPoint(selectedCustomTest.airPressureCycles2);
// //     setNumberOfCycles(selectedCustomTest.numOfCycles);
// //     setTestID(selectedCustomTest.id);

// //     dispatch(
// //       devicesActions.setAllPageStatus({
// //         deviceID: deviceID,
// //         wardToggle: selectedCustomTest.loadingDirection,
// //       })
// //     );
// //   };

// //   // Function to set test parameters based on selected test (preset or custom)
// //   const setTestParametersFromTest = (test) => {
// //     setButtonName("Start");
// //     setButtonClass("btn btn-success btn-lg");
// //     setSetPoint(test.pressure);
// //     setHoldTime(test.duration);
// //     setTestID(test.id);
// //     setNumberOfCycles(test.cycles);

// //     dispatch(
// //       devicesActions.setAllPageStatus({
// //         deviceID: deviceID,
// //         wardToggle: test.type,
// //       })
// //     );
// //   };
...
// //     if (custom_preset_toggle === "Preset") {
// //       if (toggle === "dynamic_load") {
// //         const availableTests = CyclicTests.filter((test) => test.finished !== true);
// //         if (availableTests.length > 0) {
// //           handleTestSelection({ target: { value: 0 } });
// //         }
// //       } else if (toggle === "static_load") {
// //         const availableTests = StaticTests.filter((test) => test.finished !== true);
// //         if (availableTests.length > 0) {
// //           handleTestSelection({ target: { value: 0 } });
// //         }
// //       }
// //     }
// //   }, [CyclicTests, StaticTests, toggle]);
...
// //           {custom_preset_toggle === "Preset" ? (
// //             toggle === "dynamic_load" && CyclicTests.length > 0 ? (
// //               CyclicTests.filter((test) => test.finished !== true).length > 0 ? (
// //                 <option key={0} value={0}>
// //                   Test {CyclicTests.find((test) => !test.finished).index + 1}{" "}
// //                   {CyclicTests.find((test) => !test.finished).type}
// //                 </option>
...
// //               )
// //             ) : toggle === "static_load" && StaticTests.length > 0 ? (
// //               StaticTests.filter((test) => test.finished !== true).length > 0 ? (
// //                 StaticTests.filter((test) => test.finished !== true).map(
// //                   (test, index) => (
// //                     <option key={index} value={index}>
// //                       Test {test.index + 1} {test.type}
...
//     // Check if the selectedValue is for a custom row
//     if (selectedValue.startsWith("custom-cyclic-")) {
//       const index = parseInt(selectedValue.split("-")[2], 10); // Extract index from custom-cyclic-X
//       console.log("Selected custom cyclic test index:", index);
  
//       if (index >= 0 && index < customCyclicRows.length) {
//         const selectedTest = customCyclicRows[index];
//         setselectedTestCyclicIndex(index);
//         setPositiveSetPoint(selectedTest.high_pressure);
//         setNegativeSetPoint(selectedTest.low_pressure);
//         setNumberOfCycles(selectedTest.numOfCycles);
//         setTestID(selectedTest.id);
...
//           devicesActions.setAllPageStatus({
//             deviceID: deviceID,
//             wardToggle: selectedTest.loadingDirection,
//           })
//         );
//       } else {
//         console.log("Selected value is out of bounds for custom cyclic tests!");
//         setSelectedTest(null);  // Reset selected test if out of bounds
//       }
//     } else if (toggle === "dynamic_load") {
//       const availableTests = CyclicTests.filter((test) => test.finished !== true);
//       if (selectedValue >= 0 && selectedValue < availableTests.length) {
//         const selectedTest = availableTests[selectedValue];
//         setselectedTestCyclicIndex(selectedTest.index);
//         setPositiveSetPoint(selectedTest.high_pressure);
//         setNegativeSetPoint(selectedTest.low_pressure);
//         setNumberOfCycles(selectedTest.cycles);
...
//         );
//       } else {
//         console.log("Selected value is out of bounds for cyclic tests!");
//         setSelectedTest(null);  // Reset selected test if out of bounds
//       }
//     } else if (toggle === "static_load") {
//       const unfinishedTests = StaticTests.filter((test) => test.finished !== true);
...
//         );
//       } else {
//         console.log("Selected value is out of bounds for static tests!");
//         const defaultTest = unfinishedTests[0];
//         setSetPoint(defaultTest.pressure);
//         setHoldTime(defaultTest.duration);
//         setTestID(defaultTest.id);
  
//         dispatch(
//           devicesActions.setAllPageStatus({
//             deviceID: deviceID,
//             wardToggle: defaultTest.type,
//           })
//         );
//       }
//     }
