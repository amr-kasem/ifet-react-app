...
// Same bootstrap fetches as App.js startup (no page refresh)
export const reloadBootstrapData = () => async (dispatch) => {
  await Promise.all([
    dispatch(fetchDeviceData()),
    dispatch(fetchTurboData()),
    dispatch(fetchCommonValvesData()),
    dispatch(fetchCommonSensorsData()),
  ]);
